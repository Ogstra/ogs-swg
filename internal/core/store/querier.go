...
type Querier interface {
	...
	GetSubscriptionByToken(ctx context.Context, token string) (GetSubscriptionByTokenRow, error)
	...
	GetSubscriptionsForUser(ctx context.Context, userName string) ([]GetSubscriptionsForUserRow, error)
